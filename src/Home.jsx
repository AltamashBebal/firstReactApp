...
<section className="text-gray-700 body-font">
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
      <div className="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col text-center items-center">
        ...
        <div className="flex-grow">
          ...
          <Link to="/Details"  className="mt-3 text-indigo-500 inline-flex items-center">Learn More
   ...
   <Link to="/Details"> <button  className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Know More</button></Link> 
  </div>
</section>
    </>
    );
